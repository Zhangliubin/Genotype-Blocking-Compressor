...
public interface ISwitcher {
    ...
    static ISwitcher getInstance(boolean permutation) {
        return permutation ? Switcher.INSTANCE : EmptySwitcher.INSTANCE;
    }
     ...
     * @param encodedCache 编码值缓冲区
     */
    void switchingRow(MBEGEncoder encoder, VariantAbstract[] variants, int variantsNum, byte[] encodedCache);
