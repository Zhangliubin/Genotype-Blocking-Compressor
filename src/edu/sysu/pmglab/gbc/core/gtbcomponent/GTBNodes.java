...
public class GTBNodes implements Iterable<GTBNode> {
    ...
    GTBNodes(GTBNode[] nodes) {
        ...
        this.nodes = new Array<>(nodes, true);
    }
    ...
    public GTBNodes(String chromosome) {
        this(ChromosomeTags.getIndex(chromosome));
    }
    ...
    public GTBNodes(int chromosomeIndex, int capacity) {
        ...
        this.nodes = new Array<>(capacity, true);
    }
    ...
    public GTBNodes(String chromosome, int capacity) {
        this(ChromosomeTags.getIndex(chromosome), capacity);
    }
    ...
    public String getRootInfo() {
        if (this.nodes.size() > 0) {
            return String.format("Chromosome %s: posRange=[%d, %d], numOfNodes=%d, numOfVariants=%d",
                    ChromosomeTags.getString(chromosomeIndex), get(0).minPos, get(-1).maxPos, this.nodes.size(), numOfVariants());
        } else {
            return String.format("Chromosome %s: No. of nodes=0, No. of variants=0", ChromosomeTags.getString(chromosomeIndex));
        }
    }
