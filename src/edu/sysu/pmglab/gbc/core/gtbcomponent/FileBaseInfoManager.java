...
public class FileBaseInfoManager {
     ...
     * @param task 压缩任务
     */
    public static FileBaseInfoManager of(IBuildTask task) {
        return new FileBaseInfoManager(false, task.getCompressor(), task.isPhased(), task.getBlockSizeType(), task.getCompressionLevel());
    }
