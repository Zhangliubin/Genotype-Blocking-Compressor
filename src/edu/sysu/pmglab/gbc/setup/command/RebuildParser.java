    ...
    RebuildParser() {
        ...
        parser.register("--random")
                ...
                .convertTo(params -> {
                    ...
                    HashMap<String, BaseArray<Integer>> elementSet = new HashMap<>();
                    ...
                    try (FileStream fs = new FileStream(params[0])) {
                        ...
                        for (String chromosomeN : elementSet.keySet()) {
                            BaseArray<Integer> positions = elementSet.get(chromosomeN);
                            if ((positions != null) && (positions.size() > 0)) {
                                ...
                                // 提取最终结果
                                target.put(chromosomeN, (int[]) positions.toBaseArray());
                            }
                        }
