    ...
    LDParser() {
        ...
        parser.register("--model", "-m")
                ...
                .convertTo((IConverter<ILDModel>) params -> {
                    ...
                    if ("GENO".equals(param) || "--GENO".equals(param) || "--GENO-LD".equals(param) || "--GENO-R2".equals(param)) {
                        return ILDModel.GENOTYPE_LD;
                    } else if ("HAP".equals(param) || "--HAP".equals(param) || "--HAP-LD".equals(param) || "--HAP-R2".equals(param)) {
