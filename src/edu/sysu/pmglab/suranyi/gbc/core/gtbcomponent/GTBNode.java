...
public class GTBNode implements Comparable<GTBNode> {
    ...
    public GTBNode(String chromosome, int minPos, int maxPos, long blockSeek, int genotypeSize, int posSize, int alleleSize,
                   byte magicCode, short[] subBlockVariantNum) {
        this(ChromosomeInfo.getIndex(chromosome), minPos, maxPos, blockSeek, genotypeSize, posSize, alleleSize, magicCode, subBlockVariantNum);
    }
    ...
    public GTBNode(String chromosome, int minPos, int maxPos, long blockSeek, int genotypeSize, int posSize, int alleleSize,
                   int originMBEGsSize, int originAllelesSize, short[] subBlockVariantNum) {
        this(ChromosomeInfo.getIndex(chromosome), minPos, maxPos, blockSeek, genotypeSize, posSize, alleleSize, calculateMagicCode(originMBEGsSize, originAllelesSize), subBlockVariantNum);
    }
    ...
    public int getEstimateDecompressedSize(int validSubjectNum) {
        long originSize = (ChromosomeInfo.getString(chromosomeIndex).length() + ValueUtils.byteArrayOfValueLength(maxPos) + ValueUtils.byteArrayOfValueLength(validSubjectNum * 2) * 2L + 31) * numOfVariants() +
