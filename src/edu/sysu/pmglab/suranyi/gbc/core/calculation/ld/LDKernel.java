...
import edu.sysu.pmglab.suranyi.gbc.core.gtbcomponent.gtbreader.Pointer;
...
class LDKernel {
    ...
    private void calculateLD() throws Exception {
        try {
            ...
            if (block.getStatus()) {
                ...
                SmartList<Variant> variants = new SmartList<>(this.maxCacheBlockSize);
                SmartList<Variant> processedVariants = new SmartList<>(this.maxCacheBlockSize + 1);
                ...
                do {
                    ...
                    while (!variants.isEmpty() || !endOfChromosome) {
                        ...
                        if (variant1.position > endPosition) {
                            ...
                            processedVariants.add(variants);
                            variants.clear();
                            break;
                        }
    ...
    public boolean fillCache(int localIndex, SmartList<Variant> variants, SmartList<Variant> processedVariants, GTBReader reader, int searchEndPosition) throws IOException, InterruptedException {
        // 加载初始化位点
        Variant variant;
